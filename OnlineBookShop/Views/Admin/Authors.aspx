<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="Authors.aspx.cs" Inherits="OnlineBookShop.Views.Admin.Authors" %>
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="mb-3">
                    ...
                    <input type="text" placeholder="Name" autocomplete="off" class="form-control" runat="server" id="txtAuthorName"/>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <asp:DropDownList runat="server" class="form-control" id="ddlCountry">
            ...
            <div class="col-md-8">
                <asp:GridView ID="grvAuthorsList" runat="server" class="table " CellPadding="4" ForeColor="#333333" GridLines="None" AutoGenerateSelectButton="True" OnSelectedIndexChanged="grvAuthorsList_SelectedIndexChanged">
