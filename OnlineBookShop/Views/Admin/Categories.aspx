        ...
        <div class="row">
            <div class="col-md-4">
                <div class="mb-3">
                    ...
                    <input type="text" placeholder="Name" autocomplete="off" class="form-control" runat="server" id="txtCatName" />
                </div>
                <div class="mb-3">
                    <label for="" class="form-label text-success">Category Description</label>
                    <input type="text" placeholder="Description" autocomplete="off" class="form-control" runat="server" id="txtDescription" />
                </div>
            ...
            <div class="col-md-8">
                <asp:GridView ID="grvCategoriesList" runat="server" class="table " CellPadding="4" ForeColor="#333333" GridLines="None" AutoGenerateSelectButton="True" OnSelectedIndexChanged="grvCategoriesList_SelectedIndexChanged">
